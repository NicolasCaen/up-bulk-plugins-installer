...
class PUBPI_JsRegisterGenerator extends PUBPI_BaseGenerator {
    public function type(): string { return 'js_register'; }
    public function label(): string { return 'JS Register'; }
    ...
    protected function perFileLines(array $cfg, string $abs, string $rel_from_base, string $target_file, string $base_dir, string $base_uri): array {
        ...
        return ["wp_register_script('{$handle}', " . $url_expr . ", {$deps_php}, null, {$in_footer});"];    }
